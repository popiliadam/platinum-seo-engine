...
- **Commit:** v1.9.2 retry-on-busy (2 work files sf_mcp_client.py + test + 2 state docs). c6c0268 (v1.9.1 transport) + this (v1.9.2). Both unpushed; release decision after the SF MCP campaign completes.
