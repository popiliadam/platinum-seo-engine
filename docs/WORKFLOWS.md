...
| `migration-map` (GAP-T4 NEW) | "migration map", `/pseo-migration-map` | wip |
...
python3 scripts/migrations/migration_0005_project_config_1_4_to_1_5.py --project demo-furniture --dry-run

# Inspect output; if OK, apply (creates .bak backup):
python3 scripts/migrations/migration_0005_project_config_1_4_to_1_5.py --project demo-furniture
