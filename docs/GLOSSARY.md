...
- **Invariant** — Cross-sheet rule, master.xlsx içi sheet'ler arası kural. 32 CSR rule mevcut (`schemas/cross-sheet-invariants.json` `rules` SoT; v1.8 SF MCP invariant'ları dahil); her Excel write sonrası denetlenir.
