...
- `df4aa3f` — Q-V1.4-BOOTSTRAP-PATHS-01 raised: demo-hvac onboarding kanıt
...
- `d6ad192` — Tier 3: multi-project e2e smoke test (demo-hvac + demo-dental
  parallel onboarding)
...
demo-hvac onboarding case zafer: 2'inci proje portfolio scaffold modern conv ile
...
- **Multi-project capability test** — yeni proje onboard pipeline e2e (~120 dk
  ayrı session); Tier 3 d6ad192 covered partial (demo-hvac + demo-dental smoke);
