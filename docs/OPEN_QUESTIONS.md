...
### Q-V1.4-AUDIT-CRITICAL-01: Deep audit 9 CRITICAL findings — rules/+schemas/+templates/ engine self-violation [P1]
...
### Q-V1.4-AUDIT-HIGH-01: Deep audit 12 HIGH theme — frontmatter+pattern+coupling drift [P1]
...
### Q-V1.4-AUDIT-GOVERNANCE-01: Deep audit 6 missing regression test + drift-check expansion [P1]
...
### Q-V1.4-BOOTSTRAP-DEFAULT-OUT-01: bootstrap_project.py default --out path PSEO_WORKSPACE_ROOT-aware değil [P3]
