...
### Q-V1.4-AUDIT-HIGH-01: Deep audit 12 HIGH theme — frontmatter+pattern+coupling drift [P1] ✅ RESOLVED 2026-05-07
...
### Q-V1.5-HOOK-SCRIPTS-MISSING-01: 4 cited scripts/hooks/* not authored — rules claim pre-commit hooks that do not exist [P2]
