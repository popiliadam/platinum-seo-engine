...
**Raised:** 2026-06-02 OW workshop, live tool-testing on a real crawl (aluminumstation, 1822 URLs).
...
**Cross-refs:** `scripts/util/sf_mcp_client.py` (retry-on-busy `_is_spider_busy` + busy_retry_max); Q-V1.9.1-SF-MCP-TRANSPORT-01 (transport fix); Fix Worker package (v1.9.2); live evidence (aluminumstation crawl).
