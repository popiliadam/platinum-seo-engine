...
| OQ-FILEPATH-EXPORTS | Verify the 24-report orchestrator + 4 consumer skills use `file_path` (not inline) for >100KB exports — SF rejects inline at 100KB (D-SF-05 cap; SF server itself instructs file export). | **P2** (Task B verify) |
