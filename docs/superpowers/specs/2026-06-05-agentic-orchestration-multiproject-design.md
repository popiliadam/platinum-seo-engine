...
- **10 projects already exist** on disk (demo-agency, demo-aluminum, demo-petcare, demo-dental, demo-hvac, demo-fintech, demo-tires, demo-construction, demo-furniture, demo-baby); `ACTIVE_PROJECTS_MAX=12` is copy-pasted across 6 reporting files + maxItems=12 in 3 schemas. "3-5 projects" is the demo; the real portfolio is 10 and climbing toward the cap.
