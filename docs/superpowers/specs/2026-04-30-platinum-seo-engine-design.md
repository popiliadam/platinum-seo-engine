...
- **İçermez:** Proje isimleri ("demo-dental"), proje verisi, state, output.
...
├── projects/
│   ├── demo-dental/                      # her proje aynı yapıda
...
│   ├── demo-furniture/, demo-hvac/, demo-petcare/, demo-shop/, demo-tires/, demo-construction/, demo-agency/
│
├── shared/
...
│   └── active.json                      # {"active_project": "demo-dental"}
│
...
Plugin repo içinde "demo-dental", "demo-furniture" gibi proje adı **GEÇMEZ**. CI grep ile kontrol eder.
...
**Acceptance:**
- Pilot proje (örn demo-dental) end-to-end smoke test PASS
...
**Goal:** Workspace repo açılır, CI tam pipeline'la çalışır, pilot proje (demo-dental) baştan sona test edilir.
**Deliverables:**
...
7. ✅ Pilot proje (örn demo-dental) end-to-end:
...
- **Q-003:** Pilot proje hangisi? demo-dental / demo-furniture / demo-hvac / demo-petcare / başka? (Öneri: demo-dental — eski premium'da en olgun klasör.)
...
- **Pilot Proje:** v1 acceptance test'i için kullanılan proje (öneri: demo-dental)
...
```markdown
[SISTEM NOTU]
🔴 demo-dental: 3 RED drift bulgusu var (drift-check 2026-04-30 09:00)
🟠 demo-furniture: 12 yeni quick win onayı bekliyor
🟢 demo-hvac: tüm sistemler temiz
```
