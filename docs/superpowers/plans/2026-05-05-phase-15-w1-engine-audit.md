...
```bash
ls /Users/apple/Documents/platinum-seo-workspace/projects/dentnotion/_state/backups/ 2>/dev/null | wc -l
# Son backup var mı?
ls -la /Users/apple/Documents/platinum-seo-workspace/projects/dentnotion/_state/backups/ 2>/dev/null | tail -5
```
...
Commit içeriği:
- `projects/dentnotion/outputs/reports/v1-audit-2026-05-05/01-engine-repo/` 8 alt-report
- `projects/dentnotion/_state/events.jsonl` +1 audit_run event (event_type="audit_run")
...
| Audit output | workspace: `projects/dentnotion/outputs/reports/v1-audit-2026-05-05/01-engine-repo/` | `ls /Users/.../platinum-seo-workspace/projects/dentnotion/outputs/` |
