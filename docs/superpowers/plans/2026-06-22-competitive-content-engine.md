...
- **Plugin-agnostik:** proje slug hardcode YASAK — `demo-dental`, `demo-furniture`, `demo-hvac`, `demo-petcare`, `demo-shop`, `demo-tires`, `demo-construction`, `demo-agency` FORBIDDEN tokens (pytest grep verify). CSS class `pse-` prefix.
