...
Apply the default and proceed UNLESS he overrides:
  D-1: which slug becomes the active marker (finding 1)            -> default: a healthy slug he names; fix noran data regardless
  D-2: adstark run_id files — rename vs relax schema (finding 2)   -> default: rename the 2 files
