...
|---|---|---|---|
| T2 faceted/crawl-budget | HIGH — 4+ e-commerce clients (Ticimax/Ideasoft/imagaza/WooCommerce) mass-generating parameter URLs today; demo-hvac 1717-URL head-ordering + /arama redirect symptoms are this class | M | **Now — Batch 1** |
