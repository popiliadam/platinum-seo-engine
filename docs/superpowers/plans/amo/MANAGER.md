...
| 3d | Replicate `content-pipeline` (blog/content generation — model_attested/content-quality + AI-disclosure gate; the HARDEST replicate, likely last) | pending | 3a |
