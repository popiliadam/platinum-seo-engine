...
> file-disjoint → up to 3 parallel windows.** Plan: **WAVE-1 = 2a (consent substrate) [✅ DONE `de44bbd`] ∥ 2c (denetçi) [✅ DONE `e50d655`] + 2d (oracle) [DISPATCHED, in-flight]; WAVE-2 = 2b (PreToolUse gates, needs 2a's ledger +
