...
> size batches up**. **NEXT (Süleyman's call): 3c/3d (new-project-setup + content-pipeline) · 3-gov (lint #2 +
> drift-F-rule + secret-bytes) · 3-oracle (generalize the oracle).**
