...
> **Faz 1 PROGRESS: 1a ✅ DONE+GREEN (`7c8d66d`, schema freeze, 1803/0). Spec's 1b SPLIT → 1b (machinery, greenfield) + 1b2 (skill-write relocation, isolated). 1b prompt AUTHORED; 1b ∥ 1c (file-disjoint parallel windows).**
