...
**Hedef:** Workspace repo (`platinum-seo-workspace/projects/demo-dental/`) kapsamlı audit.
...
demo-dental project path: `/Users/apple/Documents/platinum-seo-workspace/projects/demo-dental`

### Worker W-S1 — Kategori 9+10: Data Integrity + Plugin Boundary

**Kategori 9: demo-dental Data Integrity + master.xlsx**

master.xlsx sheet inventory:
```python
import openpyxl
wb = openpyxl.load_workbook(
    '/Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/master.xlsx',
...
python3 -c "
import openpyxl
wb = openpyxl.load_workbook('/Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/master.xlsx', read_only=True)
ws = wb['quick_wins']
...
```bash
grep -r "demo-dental" /Users/apple/Documents/platinum-seo-engine/ \
  --include="*.py" --include="*.md" --include="*.json" \
  --exclude-dir=".git" | grep -v "CONTEXT_LEDGER\|PHASE_STATUS\|DECISIONS\|memory" | head -10
# Engine repo'da "demo-dental" hard-coded olmamalı (sadece docs/memory'de kabul edilebilir)
```

8 workspace slug cross-check (engine SKILL.md'de slug literal var mı?):
```bash
grep -r "platinum-seo-workspace\|projects/demo-dental" \
...
- demo-dental in engine skills: [0 hit PASS / XX hit FAIL]
...
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/inbox/
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/inbox/gsc/ 2>/dev/null | head -5
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/inbox/dfs/ 2>/dev/null | head -5
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/inbox/scrapling/ 2>/dev/null | head -5

# Stage 3-4: Discovery + Planning
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/outputs/reports/ 2>/dev/null | head -10

# Stage 5-7: Production + Publishing + Verify
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/outputs/content/ 2>/dev/null | head -10
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/outputs/tech/ 2>/dev/null | head -10
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/outputs/indexing/ 2>/dev/null | head -5
```

_state directory full inventory:
```bash
ls -la /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/_state/
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/_state/workflows/ 2>/dev/null | head -5
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/_state/cache/ 2>/dev/null | head -5
```
...
# → 84 satır beklenen
# Son event:
tail -1 /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/_state/events.jsonl | python3 -m json.tool
...
python3 -c "
import json
report = json.load(open('/Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/_state/consistency-report-demo-dental.json'))
...
```bash
ls -la /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/_state/backups/
# Tam içerik listesi

# Root level backup files:
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/_state/*.bak 2>/dev/null
ls /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/_state/*.backup 2>/dev/null
...
| D-4 | demo-dental PII (gerçek hasta verisi?) bulunursa | STOP → KVKK concern → escalate |
...
| G-10 | Plugin boundary | workspace .mcp.json absent + 0 demo-dental slug in engine skills |
...
| demo-dental project | `projects/demo-dental/` | `ls /Users/.../platinum-seo-workspace/projects/demo-dental/` |
| master.xlsx | `projects/demo-dental/master.xlsx` | `ls -la .../master.xlsx` |
| events.jsonl | `projects/demo-dental/_state/events.jsonl` | `wc -l .../events.jsonl` |
| config | `projects/demo-dental/config/project.config.json` | verify path (config/ dir mevcut mu?) |
...
| Audit output | `projects/demo-dental/outputs/reports/v1-audit-2026-05-05/02-workspace-repo/` | mkdir if needed |
