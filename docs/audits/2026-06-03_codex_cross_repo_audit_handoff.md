...
python3 scripts/validation/validate_schema.py \
  /Users/apple/Documents/platinum-seo-workspace/projects/demo-dental/project.config.json \
...
PSEO_WORKSPACE_ROOT=/Users/apple/Documents/platinum-seo-workspace \
  python3 scripts/state/dump_workspace.py --project demo-dental --json
# PASS
```
...
- `projects/demo-dental/project.config.json` has schema version older than `1.5`.
