...
events_writer.append_audit(
    ...
    audit_target=f"reports:portfolio-task-heatmap:{report_date}",
    actor="agent:portfolio-task-heatmap",
    workspace_root=workspace_root,
    notes=f"local_aggregation report-only (portfolio-task-heatmap; date={report_date})",
)
```
