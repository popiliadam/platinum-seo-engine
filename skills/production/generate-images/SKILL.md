...
|-------------------------------|-------------------------------------------------------------|--------------------------------------------------|
| `.mcp.json`                   | Project-local (3 servers: gsc, dataforseo, ScraplingServer) | Plugin agnostik; Higgsfield ABSENT (F-16 intact) |
...
- `.mcp.json` (3 servers: `gsc`, `dataforseo`, `ScraplingServer`;
