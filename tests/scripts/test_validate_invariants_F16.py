...
def test_extract_url_freeform_format() -> None:
    ...
    text = "Optimize https://demo-dental.example/gece-plagi-splint-nedir-nasil-kullanilir/ for query 'splint nedir'"
    assert _extract_url_from_action_field(text) == "https://demo-dental.example/gece-plagi-splint-nedir-nasil-kullanilir/"
