...
master.xlsx
(``…/projects/demo-aluminum-ca/master.xlsx``); the raw CSVs are the REAL
...
_PROJECT_SLUG = "demo-aluminum-ca"
_WS_PROJECT = Path(
    "/Users/apple/Documents/platinum-seo-workspace/projects/demo-aluminum-ca"
)
