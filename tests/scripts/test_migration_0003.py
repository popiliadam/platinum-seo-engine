...
Coverage:
  ...
  6. Workspace demo-dental fixture validates against schema 1.3 after migration.
"""
...
def test_workspace_fixture_validates_after_migration(
    ...
    fixture = {
        ...
        "domain": "https://demo-dental.example/",
        "market": "TR",
        ...
        "paths": {
            "workspace_root": "~/Documents/platinum-seo-workspace/projects/demo-dental",
        ...
        "gsc": {"site_url": "https://demo-dental.example/"},
