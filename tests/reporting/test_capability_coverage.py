...
from tests._count_pins import SKILL_COUNT
...
def test_classify_skills_partitions_all_real_skills():
...
def test_coverage_report_static_only_has_no_runtime():
    ...
    assert report["skills"]["total"] == SKILL_COUNT
...
def test_render_report_contains_headline_counts_and_categories():
    ...
    assert str(SKILL_COUNT) in out  # the skill total
