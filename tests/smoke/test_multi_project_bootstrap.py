...
isolation + eykom workaround obsolete kanıt + init-project §Step 4 paterni.
"""
...
def test_eykom_rerun_obsolete_workaround() -> None:
    ...
    cmd = [
        sys.executable, str(SCRIPT),
        "--project", "eykom",
        "--domain", eykom_actual["domain"],
        "--market", eykom_actual["market"],
        "--locale", eykom_actual["language"]["content_locale"],
        "--currency", eykom_actual["currency"],
        "--platform", eykom_actual["platform"],
        "--profile", eykom_actual["profiles"][0],
        "--dry-run",
    ]
