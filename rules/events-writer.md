...
events_writer.append_work(
    ...
    url="https://demo-dental.example/blog/izmir-implant-tedavisi-fiyatlari-2026",
    url_normalized="https://demo-dental.example/blog/izmir-implant-tedavisi-fiyatlari-2026",
...
events_writer.append_provenance(
    project_id="demo-dental",
    run_id=events_writer.next_run_id("demo-dental"),
